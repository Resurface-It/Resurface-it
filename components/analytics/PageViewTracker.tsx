 ...
 * GA4 does not automatically track client-side navigation, so this component
 * listens for route changes and sends pageview events.
 * 
 * Usage:
 ...
 *   3. Safely handles SSR (only runs on client)
 */
