...
const eugeneInteriorFAQs = [
  {
    question: 'How much does interior painting cost in Eugene, OR?',
    answer: 'Interior painting in Eugene typically costs $2,500 to $8,000 depending on the number of rooms, square footage, and complexity. A single room can cost $500-$1,500, while whole-home projects range from $5,000-$12,000. We provide detailed estimates within 24 hours.',
    category: 'interior-painting' as const,
  },
  {
    question: 'Do you paint kitchens and bathrooms in Eugene homes?',
    answer: 'Yes! We specialize in kitchen and bathroom painting in Eugene. These spaces require moisture-resistant paints and special preparation. We use washable, moisture-resistant finishes in satin or semi-gloss that stand up to steam, splashes, and regular cleaning—essential for Eugene\'s humidity.',
    category: 'interior-painting' as const,
  },
  {
    question: 'How long does interior painting take in Eugene?',
    answer: 'Most interior painting projects in Eugene take 2-7 days depending on the number of rooms and complexity. A single room can often be completed in one day, while whole-home projects may take 5-7 days. We work efficiently to minimize disruption to your daily routine.',
    category: 'interior-painting' as const,
  },
]

export default function EugeneInteriorPaintingPage() {
  const serviceDescription = 'Professional interior painting services in Eugene, OR. Transform every room in your home with expert craftsmanship, premium paints, and attention to detail.'
  const serviceSchema = generateServiceSchema('Interior Painting in Eugene, OR', serviceDescription)
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-primary/5 to-surface pt-32 pb-16">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="mb-6 text-4xl font-bold md:text-5xl">Interior Painting in Eugene, OR</h1>
            <p className="mb-8 text-xl text-slate-600">
              Transform every room in your Eugene home with professional interior painting. From living rooms and bedrooms to kitchens and bathrooms, we bring expert craftsmanship and premium paints to every project.
            </p>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <p className="mb-4 text-lg leading-relaxed">
              Our interior painting service in Eugene covers every aspect of your project. We paint all interior spaces including living rooms, dining rooms, bedrooms, kitchens, bathrooms, hallways, home offices, and more. Each room type receives specific attention—we use moisture-resistant paints in bathrooms and kitchens, durable finishes in high-traffic areas, and the right sheen for each space.
            </p>
            <p className="mb-4 text-lg leading-relaxed">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              We use premium interior paints from trusted brands like Sherwin-Williams and Benjamin Moore, with low-VOC and zero-VOC options available for healthier indoor air quality. Our team provides expert color consultation to help you choose the perfect shades for your Eugene home.
            </p>
          </div>
        </div>
      </Section>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                description: 'We clean up thoroughly, remove all protection materials, and return furniture to its original position. Touch-ups are completed, and we ensure everything is perfect before we leave. Your Eugene home is left clean and beautiful.',
              },
            ].map((step, index) => (
      ...
      <Section>
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-6 text-3xl font-bold">Why Interior Painting Matters in Eugene</h2>
          <div className="prose prose-lg max-w-none text-slate-700">
            <p className="mb-4 text-lg leading-relaxed">
              Eugene&apos;s climate, with its high humidity and temperature fluctuations, can affect interior paint performance. We use paints specifically chosen for their ability to handle these conditions. In kitchens and bathrooms, moisture-resistant finishes are essential to prevent peeling and mildew growth.
            </p>
            <p className="mb-4 text-lg leading-relaxed">
              Proper surface preparation is especially important in Eugene homes, where humidity can cause paint adhesion issues if surfaces aren&apos;t properly cleaned and primed. We never skip steps—every wall is properly prepared before paint application.
            </p>
            <p className="mb-6 text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="relative aspect-[4/3] overflow-hidden rounded-xl bg-slate-200">
              <Image
                ...
                alt="Interior painting project in Eugene, OR"
                fill
      ...
      <Section>
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mx-auto max-w-3xl">
            <FAQAccordion faqs={eugeneInteriorFAQs} />
          </div>
        </div>
      </Section>
      ...
      <Section className="bg-primary text-white">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-4 text-3xl font-bold">Ready to Transform Your Eugene Home&apos;s Interior?</h2>
          <p className="mb-8 text-lg text-white/90">
            Get your free, no-obligation estimate for interior painting in Eugene. We&apos;ll visit your home, assess your project, and provide a detailed quote.
          </p>
          <HousecallProButton
            variant="large"
