...
export const metadata: Metadata = genMeta({
  title: 'Siding Replacement & Painting in Springfield, OR | Resurface-it',
  description: 'Professional siding replacement and painting services in Springfield, OR. Hardie board, vinyl & fiber cement installation. Exterior & interior painting. 5-year warranty. Licensed & insured. Free estimates.',
  path: '/springfield-or',
})
