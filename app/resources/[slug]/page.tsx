...
const resourceContent: Record<string, { content: string; faqs: Array<{ question: string; answer: string; category: 'siding' | 'exterior-painting' | 'interior-painting' | 'roofing' | 'warranty' | 'scheduling' | 'city-specific' }> }> = {
